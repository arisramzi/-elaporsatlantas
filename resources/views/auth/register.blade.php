...
<head>
    ...
    <title>Daftar Akun - Satlantas</title>
...
<body class="bg-[#0f172a] text-white antialiased">
    ...
    <div class="relative z-10 min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 px-4 py-12">
        ...
        <div class="mb-6 text-center">
            ...
            <p class="text-slate-400 mt-2 text-sm font-medium">Buat Akun Pelapor Baru</p>
        </div>
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div class="text-center mt-2">
                        <span class="text-slate-400 text-sm">Sudah punya akun?</span>
                        <a href="{{ route('login') }}" class="text-sm font-bold text-blue-400 hover:text-blue-300 transition ml-1">
                            Masuk di sini
                        </a>
                    </div>
                </div>
